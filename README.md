...
Git Desktop + VS Code
Very nice combo IMO.
First of all we work with VS Code.
1. We create folder with our future project.
2. We can add some files in it (Like I do RN).
...
5. Pressing Initialize Repository will do all job! Let's "Commit" some changes we just got